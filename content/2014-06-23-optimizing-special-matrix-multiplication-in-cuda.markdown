...
Date: 2014-06-23 20:56:00
description: Optimizing Special Matrix Multiplication in CUDA
Tags: CUDA, tech, CS, CUDA, GPGPU, GPU, 矩阵乘法, Reed-Solomon, Galois Field, matrix multiplication, c++, c, template, cuBLAS, MAGMA
Slug: 20140623-optimizing-special-matrix-multiplication-in-cuda
Category: tech
...
![image](/images/mm-CUDA/without-tiling.png)
...
![image](/images/mm-CUDA/square-tiling.png)
...
![image](/images/mm-CUDA/tiling.png)
