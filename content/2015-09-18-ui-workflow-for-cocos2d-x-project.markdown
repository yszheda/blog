...
Date: 2015-09-18 23:22:00
description: UI Workflow for Cocos2d-x Client Development
Tags: cocos2d-x, CS, tech, cocos2d-x, quick, quickx, quick-cocos2d-x, cocos, cocos2d, 游戏开发, 手游开发, mobile game, game devolopment, cocostudio, TexturePacker
Slug: 20150918-ui-workflow-for-cocos2d-x-project
Category: tech
...
![image](/images/ui-workflow/1_1_tp.png)

![image](/images/ui-workflow/1_2_tp.png)
...
![image](/images/ui-workflow/2_1_import.png)

![image](/images/ui-workflow/2_2_import.png)

![image](/images/ui-workflow/2_3_import.png)

5.新建合图(Sprite Sheet)文件，注意文件名必须是之前`TexturePacker`所导出的图集名字：

![image](/images/ui-workflow/3_1_csi.png)

![image](/images/ui-workflow/3_2_csi.png)

![image](/images/ui-workflow/3_3_csi.png)

6.在合图文件中把相应的导入资源拖进去：

![image](/images/ui-workflow/4_1_csi.png)

这时资源左上角会有记号：

![image](/images/ui-workflow/4_3_csi.png)

- _注意：右侧的设置（如“最大尺寸”）要与`TexturePacker`的设置一致。_

![image](/images/ui-workflow/4_2_csi.png)
...
![这是cocostudio默认的按钮三种状态的图](/images/ui-workflow/5_1_button.png)

![[不推荐的方式]没有指定按钮disabled状态的图片](/images/ui-workflow/5_2_button.png)

![[推荐的方式]指定按钮三种状态的图片](/images/ui-workflow/5_3_button.png)

- 关于`cocostudio` v2.1beta使用注意事项，之后会继续谈。

8.点击Publish，这时候我们只需要把`cocostudio`项目目录中res下的csb文件拷到资源目录下面就可以啦！

![image](/images/ui-workflow/6_2_publish.png)

当然，别忘了把`cocostudio`项目相关的图片、ccs、csd、csi等文件都加到版本控制里。

![image](/images/ui-workflow/6_1_proj.png)
