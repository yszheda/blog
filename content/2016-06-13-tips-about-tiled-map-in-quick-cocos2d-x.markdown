...
Slug: 20160613-tips-about-tiled-map-in-quick-cocos2d-x
Category: tech
...
![image](/images/tiled-map/meta-layer.png)

在TileSet Properties里设置一个标记"Collidable"，表示禁止被编辑：

![image](/images/tiled-map/tileset-properties.png)
...
![image](/images/tiled-map/stagger-setting.png)
...
![Y轴有奇数个tile（图中是五个），这里tile个数是这么算的：从最底端的tile沿斜线算与它有一条公共边的tile、一直算到最顶端的tile，例如从坐标(0, 4)(0, 3)(1, 2)(1, 1)到没有显示的(2, 0)](/images/tiled-map/odd-height-original-coord.png)

![Y轴有偶数个tile（图中是六个）](/images/tiled-map/even-height-original-coord.png)

# 更多Tiled Map Properties配置 #

`Tile Layer Format`最好选择压缩的格式，这样生成的tmx文件比较小。

![image](/images/tiled-map/tile-layer-format.png)
