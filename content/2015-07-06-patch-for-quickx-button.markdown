...
Date: 2015-07-06 20:20:00
description: patch for quick-cocos2d-x button
Tags: cocos2d-x, CS, tech, cocos2d-x, quick, quickx, quick-cocos2d-x, cocos, cocos2d, button, widget, 按钮, UI, 游戏开发, 手游开发, mobile game, game devolopment
Slug: 20150706-patch-for-quickx-button
Category: tech
...
[Code: StateMachine.lua.patch]

[Code: UIButton.lua.patch]

[Code: UIPushButton.lua.patch]

[Code: UICheckBoxButton.lua.patch]
