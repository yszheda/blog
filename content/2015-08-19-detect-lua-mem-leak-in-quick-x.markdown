...
Date: 2015-08-19 11:53:00
# keywords: cocos2d-x quick-cocos2d-x lua memory leak
description: detect lua memory leak in quick-cocos2d-x
Tags: cocos2d-x, CS, tech, cocos2d-x, cocos, cocos2d, 游戏开发, 手游开发, game, mobile game, game devolopment, 内存泄露, memory leak, quick-cocos2d-x, quickx, quick-x, lua
Slug: 20150819-detect-lua-mem-leak-in-quick-x
Category: tech
...
[Code: lua-snapshot/lua_snapshot_extensions.h]

[Code: lua-snapshot/lua_snapshot_extensions.c]

[Code: lua-snapshot/lua_cocos2dx_snapshot_manual.h]

[Code: lua-snapshot/lua_cocos2dx_snapshot_manual.cpp]
...
[Code: lua-snapshot/lua_module_register.h]
